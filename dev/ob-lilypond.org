...
*** TODO Add ob-ly-compile-post-tangle user variable (default t)
If ob-ly-compile-post-tangle flag set compile tangled file
Use defvar rather than defcustom for now

*** TODO Add ob-ly-draw-pdf user variable (default t)
If ob-ly-draw-pdf is true draw pdf of tangled ly file given the
